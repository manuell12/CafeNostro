...
-- Schema cafe_nostro
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `cafe_nostro` DEFAULT CHARACTER SET utf8 ;
USE `cafe_nostro` ;

-- -----------------------------------------------------
-- Table `cafe_nostro`.`categoria`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `cafe_nostro`.`producto` (
  ...
  `precio_bruto` DECIMAL(10,5) NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `cafe_nostro`.`venta_has_producto`
-- -----------------------------------------------------
