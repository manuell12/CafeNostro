...
class FormularioUsuario(QtGui.QDialog):
    ...
    def connect_actions(self):
        ...
        self.ui.lineEdit_nombre.textChanged.connect(self.lineEdit_nombre_changed)
        self.ui.lineEdit_apellido.textChanged.connect(self.lineEdit_apellido_changed)
        self.ui.lineEdit_rut.textChanged.connect(self.lineEdit_rut_changed)
        self.ui.lineEdit_verif.textChanged.connect(self.lineEdit_pass_changed)
        self.ui.lineEdit_clave.textChanged.connect(self.lineEdit_pass_changed)
        self.ui.lineEdit_clave_actual.textChanged.connect(self.lineEdit_clave_actual_changed)
        self.ui.comboBox_tipo.currentIndexChanged.connect(self.comboBox_tipo_changed)
    ...
    def lineEdit_pass_changed(self,text):
        ...
        if(self.clave == self.verif):
            self.ui.label_error_verif.setText(u"<font color='green'><b>Contraseñas coinciden.</b></font>")
        else:
            self.ui.label_error_verif.setText(u"<font color='red'><b>Contraseñas no coinciden.</b></font>")
    ...
    def lineEdit_clave_actual_changed(self,text):
        ...
        if(clave_ingresada == clave_real):
            ...
            self.ui.label_error_clave_actual.setText(u"<font color='red'><b>Contraseña ingresada incorrecta.</b></font>")

    def comboBox_tipo_changed(self,index):
        if(index != 0):
            self.ui.label_error_tipo.setText(u"<font color='green'><b>Seleccion correcta.</b></font>")
        else:
            self.ui.label_error_tipo.setText(u"<font color='red'><b>Debe seleccionar un tipo.</b></font>")
